  ...
  return (
    <div className="nous">
      ...
      <div className="nous__subtitles">
        <h3 className="nous__subtitles__h3">Hey! We host all events near you!</h3>
        <p className="nous__subtitles__p">
          enjoy <br />
          <br />
          your life
        </p>
      ...
      <div className="nous__miniBioContainer">
        <p className="nous__miniBioContainer__bio1">
        ...
        <p className="nous__miniBioContainer__bio2">
        ...
        <p className="nous__miniBioContainer__bio3">
        ...
        <p className="nous__miniBioContainer__bio4">
        ...
        <p className="nous__miniBioContainer__bio5">
      ...
      <div className="nous__partenaires">
        <img src={logo} alt="" className="nous__partenaires__logo" />
        <img src={logo} alt="" className="nous__partenaires__logo" />
        <img src={logo} alt="" className="nous__partenaires__logo" />
        <img src={logo} alt="" className="nous__partenaires__logo" />
        <img src={logo} alt="" className="nous__partenaires__logo" />
